...
class _CalendarRangePickerDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String startDateText =
        DateFormatThai.thaiShortDate(selectedStartDate);
    final String endDateText = DateFormatThai.thaiShortDate(selectedEndDate);
      ...
      children: <Widget>[
        Container(
          ...
          child: ExcludeSemantics(
            child: Text(
              DateFormatThai.thaiMonthYear(widget.displayedMonth),
